/*
  # Fix Award Carrier Function - Use Correct Tariff Activities Columns

  1. Changes
    - Fix tariff_activities INSERT to use correct column names:
      - summary -> title
      - details -> description
...
BEGIN
  ...
  -- Log to tariff activities (FIXED: use title and description columns)
