/*
  # Fix Award Carrier Function - Use Correct Family ID Column Name

  1. Changes
    - Fix column name: family_id -> tariff_family_id
    - Remove duplicate tariff_family_id in INSERT
...
BEGIN
  ...
  -- Create proposed tariff (FIXED: use tariff_family_id not family_id)
  INSERT INTO tariffs (
    tariff_reference_id,
    tariff_family_id,
    customer_id,
