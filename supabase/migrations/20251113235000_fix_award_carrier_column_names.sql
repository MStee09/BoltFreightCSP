/*
  # Fix Award Carrier Function - Use Correct Column Names and Handle Required Dates

  1. Changes
    - Fix column name: reference_id -> tariff_reference_id
    - Handle NOT NULL constraint on effective_date and expiry_date
    - Use reasonable default dates (today + 1 year)
