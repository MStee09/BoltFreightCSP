                    ...
                    <div className="space-y-3 p-4 bg-slate-50 rounded-lg border border-slate-200">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="total_shipments"
                                    type="number"
                                    value={newEvent.total_shipments}
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    type="number"
                                    value={newEvent.data_timeframe_months}
                                ...
                                <Popover>
                                    <PopoverTrigger asChild>
                                        <Button
                                            ...
                                            className={cn(
                                                "w-full justify-start text-left font-normal",
                                                !newEvent.data_start_date && "text-muted-foreground"
                                            )}
                                        >
                                            <CalendarIcon className="mr-2 h-3 w-3" />
                                            {newEvent.data_start_date ? format(new Date(newEvent.data_start_date), "PP") : "Start"}
                                        </Button>
                                    </PopoverTrigger>
                                    <PopoverContent className="w-auto p-0" align="start">
                                        <Calendar
                                            mode="single"
                                            selected={newEvent.data_start_date ? new Date(newEvent.data_start_date) : undefined}
                                ...
                                <Popover>
                                    <PopoverTrigger asChild>
                                        <Button
                                            ...
                                            className={cn(
                                                "w-full justify-start text-left font-normal",
                                                !newEvent.data_end_date && "text-muted-foreground"
                                            )}
                                        >
                                            <CalendarIcon className="mr-2 h-3 w-3" />
                                            {newEvent.data_end_date ? format(new Date(newEvent.data_end_date), "PP") : "End"}
                                        </Button>
                                    </PopoverTrigger>
                                    <PopoverContent className="w-auto p-0" align="start">
                                        <Calendar
                                            mode="single"
                                            selected={newEvent.data_end_date ? new Date(newEvent.data_end_date) : undefined}
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    type="number"
                                    value={newEvent.projected_monthly_spend}
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    type="number"
                                    value={newEvent.projected_annual_spend}
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    type="number"
                                    value={newEvent.projected_monthly_revenue}
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    type="number"
                                    value={newEvent.projected_annual_revenue}
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                type="number"
                                value={newEvent.minimum_annual_spend_threshold}
