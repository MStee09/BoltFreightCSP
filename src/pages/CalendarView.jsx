...
import { ChevronLeft, ChevronRight, Calendar as CalendarIcon, AlertTriangle, CheckCircle, Clock, FileText, Users, LayoutGrid, LayoutList, X, ExternalLink, Sparkles, TrendingUp, Target, Zap, Brain } from 'lucide-react';
...
const IntelligenceLayer = ({ events, tariffs, cspEvents }) => {
  const today = new Date();
  ...
  return (
    <Card className="mb-6 bg-gradient-to-r from-purple-50 via-blue-50 to-cyan-50 border-purple-200">
      <CardContent className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {events.filter(e => e.autoGenerated).length > 0 && (
            <PredictiveInsight
              icon={Sparkles}
