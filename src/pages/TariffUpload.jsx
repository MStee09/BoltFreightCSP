...
export default function TariffUploadPage() {
    ...
    useEffect(() => {
        setVersion('Auto-generated by system');
    }, []);
            ...
            <Card>
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="version">Tariff ID</Label>
                            <Input
                                id="version"
                                placeholder="Will be auto-generated after creation"
                                value={version}
                                disabled
                                className="bg-slate-50 text-slate-600"
                            />
                            <p className="text-xs text-slate-500">A unique tariff ID will be automatically generated based on customer, carrier, and effective date</p>
                        </div>
