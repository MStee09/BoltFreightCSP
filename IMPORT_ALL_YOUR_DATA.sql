/*
  ============================================================================
  DATA IMPORT - All Your Current Data
  ============================================================================
  
  COPY THIS FILE AND PASTE INTO SUPABASE SQL EDITOR
  
  This contains 247 rows of your actual data:
  - 40 permissions
  - 118 role mappings
  - 15 carriers (ODFL, EXLA, RDFS, DAFG, etc.)
  - 5 customers (including Torque Fitness)
  - 6 CSP events (with AI strategy summary)
  - 5 tariffs
  - 32 interactions
  - Plus: tasks, alerts, documents, settings, etc.
  
  BEFORE RUNNING THIS:
  Make sure you ran ALL_MIGRATIONS_COMBINED.sql first!
...
SELECT 'Imported 40 permissions ✓' as status;
