/*
  ...
  This file contains ALL data exported from the current Supabase database.
  Import this into your separate Supabase database, then connect Bolt to it.
  
  WORKFLOW:
  1. Run all migrations in your separate Supabase database
  2. Execute this SQL file in your separate Supabase database
  3. Create your admin user account via Supabase Auth
  4. Update the user_id references (see instructions below)
  5. Connect Bolt to your database using the "Connect" button
  
  IMPORTANT: Most records use mock user_id: 00000000-0000-0000-0000-000000000000
  After creating your admin account, you'll need to update these IDs.
  
  Data Summary:
  - 40 permissions
  - 118 role-permission mappings
  - 1 user profile (admin: michael@gorocketshipping.com)
  - 15 carriers
  - 5 customers
  - 6 CSP events (including Torque Fitness with AI-generated strategy summary)
  - 5 tariffs
  - 32 interactions
  - 3 tasks, 3 alerts
  - Plus field mappings, settings, credentials, etc.
*/
