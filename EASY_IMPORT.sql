/*
  =============================================================================
  EASY DATA IMPORT - Run this in your NEW Supabase SQL Editor
  =============================================================================
  
  This file has ALL your data ready to import!
  
  Just copy everything, paste into SQL Editor, click Run.
  
  Contains:
  ✓ 40 permissions
  ✓ 118 role mappings  
  ✓ 15 carriers (ODFL, EXLA, RDFS, etc.)
